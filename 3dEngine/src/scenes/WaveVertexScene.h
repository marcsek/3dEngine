...
#include "WaveVertexEffect.h"
#include <iostream>

class WaveVertexScene : public Scene
{
public:
	typedef Pipeline<WaveVertexEffect> Pipeline;
	typedef Pipeline::Vertex Vertex;

public:
	WaveVertexScene(Graphics& gfx)
		:incube(Plane::GetPlain<Vertex>(50)),
		pipeline(gfx)
	{
		...
		{
			vertex.color = Color::GetVector((*colorItr).hexValue);
